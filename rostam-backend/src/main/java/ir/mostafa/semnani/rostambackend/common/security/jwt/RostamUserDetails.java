...
import ir.mostafa.semnani.rostambackend.common.security.user.Role;
...
public class RostamUserDetails implements UserDetails {

    @Autowired
    private User user;

    public RostamUserDetails(User user) {
        this.user = user;
    }
